import { h, r as registerInstance, c as createEvent, H as Host, g as getElement } from './index-303021a9.js';
...
const DatePickerInput = ({ onClick, localization, name, value, identifier, disabled, role, buttonRef, inputRef, onInput, onBlur, onFocus, }) => {
  return (h("div", { class: "duet-date__input-wrapper" },
    h("input", { class: "duet-date__input", name: name, value: value, placeholder: localization.placeholder, id: identifier, disabled: disabled, role: role, "aria-autocomplete": "none", onInput: onInput, onFocus: onFocus, onBlur: onBlur, autoComplete: "off", ref: inputRef }),
